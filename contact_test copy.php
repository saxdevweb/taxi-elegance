...
<body>
      ...
      <div class="w-layout-grid contact-form-grid">
        <div id="w-node-509be705858e-d767fa79" class="contact-form-wrap">
          ...
          <div class="contact-form w-form">
            ...
            <form method="post" class="get-in-touch-form" id="sendEmail" name="sendEmail" action="sendEmail.php">
              ...
              <textarea id="body" name="message" data-name="message" maxlength="5000" placeholder="Votre texte et informations de réservation" class="text-field cc-textarea cc-contact-field w-input"></textarea>
              <input type="submit" value="Envoyer" onclick='sendEmail()' click="sendEmail()" data-wait="Please wait..." class="button w-button">
            </form>
  ...
  <script type="text/javascript">
    function sendEmail() {
      ...
      var email = $("#email");
      var date = $("#Date");
      var heureArrivee = $("#heure-arrivee");
      var message = $("#message");
      var body = $("#body");

      alert("Sending request to php file")
      $.ajax({
          url: 'sendEmail.php',
          method: 'POST',
          dataType: 'json',
          ...
          succes: function(response) {
            $('#sendEmail')[0].reset();
            $('.contact-heading-msg').text("Message envoyé avec SUCCES !")
          }
        });
